...
# 获取更多数据（前120以便筛选后还有50个）
response=$(curl -s "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=volume_desc&per_page=120&page=1&sparkline=false")
